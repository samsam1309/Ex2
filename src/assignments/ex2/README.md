...
## Known Issues
- Complex formulas with nested functions are not supported.
- Only basic arithmetic operations are implemented.

---

## Future Enhancements
- Add support for advanced functions (e.g., `sin`, `cos`, `min`, `max`).
- Improve error messages for invalid formulas.
- Optimize formula evaluation for large spreadsheets.
